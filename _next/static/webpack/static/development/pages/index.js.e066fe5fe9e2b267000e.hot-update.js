  ...
  prices.forEach(function (price) {
    ...
    if (dividend) {
      ...
      calculations.push({
        ...
        growth: totalShares * amount / totalDeposited * 100
      });
      console.log("Added ".concat(dividendShares, " dividend shares (").concat(dividendShares * amount, " euros)"));
    }

    if (date.getDate() === 1) {
      console.log("".concat(date.toISOString(), " -> ").concat(sharesToBuy, " -> ").concat(totalShares, " -> ").concat(totalDeposited, " -> ").concat(totalShares * amount, " -> ").concat(totalShares * amount / totalDeposited * 100));
    }

    if (date.getMonth() === 0) {
      console.log("Management fee paid ".concat(totalShares * (totalExpenseRatio / 100), " shares"));
...
//# sourceMappingURL=index.js.e066fe5fe9e2b267000e.hot-update.js.map